            ...
            <CardContent>
              {mockBookings.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <Button className="mt-6 bg-emerald-600 hover:bg-emerald-700" onClick={() => navigate('/tourism')}>
                    Discover Tours
                  </Button>
                </div>
              ) : (
            ...
            <CardContent>
              {savedItems.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <Button className="mt-6 bg-emerald-600 hover:bg-emerald-700" onClick={() => navigate('/discover')}>
                    Discover Morocco
                  </Button>
                </div>
              ) : (
