      ...
      <Tabs defaultValue="regions" value={activeTab} onValueChange={handleTabChange} className="mb-8">
        ...
        <TabsContent value="map" className="pt-6">
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div className="h-[600px] rounded-lg overflow-hidden border bg-muted flex items-center justify-center">
              <p className="text-muted-foreground">Interactive Map (Client-side only)</p>
            </div>
    ...
    <Card className="overflow-hidden h-full hover:shadow-md transition-shadow">
      <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="w-full md:w-3/5 flex flex-col">
          ...
          <CardFooter>
            <Button asChild variant="outline" className="w-full">
              <Link href={`#heritage-${heritage.id}`}>
                Learn More
              </Link>
            </Button>
          </CardFooter>
    ...
    <Card className="overflow-hidden h-full hover:shadow-md transition-shadow">
      <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="w-full md:w-3/5 flex flex-col">
          ...
          <CardFooter>
            <Button asChild variant="outline" className="w-full">
              <Link href={`#clothing-${clothing.id}`}>
                View Details
              </Link>
            </Button>
          </CardFooter>
