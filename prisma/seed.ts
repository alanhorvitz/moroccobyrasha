  ...
  const regions = await Promise.all([
    prisma.region.create({
      data: {
        ...
        latitude: 31.6295,
        longitude: -7.9811,
        imageUrls: ['https://images.unsplash.com/photo-1553603228-0f7053e3279e?w=800'],
      },
    }),
    prisma.region.create({
      data: {
    ...
    prisma.region.create({
      data: {
        ...
        bestTimeToVisit_it: 'Marzo a giugno, settembre a novembre',
        bestTimeToVisit_es: 'Marzo a junio, septiembre a noviembre',
        keyFacts_en: 'Largest city in Morocco, Major port city, Home to Hassan II Mosque, Capital: Casablanca',
        keyFacts_ar: 'أكبر مدينة في المغرب، مدينة ميناء رئيسية، موطن مسجد الحسن الثاني، العاصمة: الدار البيضاء',
        keyFacts_fr: 'Plus grande ville du Maroc, Ville portuaire majeure, Abrite la mosquée Hassan II, Capitale: Casablanca',
        keyFacts_it: 'Più grande città del Marocco, Città portuale importante, Sede della moschea Hassan II, Capitale: Casablanca',
        keyFacts_es: 'Ciudad más grande de Marruecos, Ciudad portuaria importante, Hogar de la Mezquita Hassan II, Capital: Casablanca',
        latitude: 33.5731,
        longitude: -7.5898,
        imageUrls: ['https://images.unsplash.com/photo-1553603228-0f7053e3279e?w=800'],
      },
  ...
  const attractions = await Promise.all([
    prisma.attraction.create({
      data: {
        ...
        imageUrls: ['https://images.unsplash.com/photo-1553603228-0f7053e3279e?w=800'],
        rating: 4.8,
        tags: ['market', 'square', 'street-food', 'entertainment'],
        entryFee: 0,
        currency: 'MAD',
      },
    }),
    prisma.attraction.create({
      data: {
        ...
        imageUrls: ['https://images.unsplash.com/photo-1553603228-0f7053e3279e?w=800'],
        rating: 4.9,
        tags: ['medina', 'unesco', 'architecture', 'culture'],
        entryFee: 0,
        currency: 'MAD',
      },
    }),
    prisma.attraction.create({
      data: {
        ...
        imageUrls: ['https://images.unsplash.com/photo-1553603228-0f7053e3279e?w=800'],
        rating: 4.7,
        tags: ['mosque', 'architecture', 'religious', 'coastal'],
        entryFee: 120,
        currency: 'MAD',
      },
    }),
    prisma.attraction.create({
      data: {
        ...
        name_ar: 'قصر الباهية',
        name_fr: 'Palais Bahia',
        name_it: 'Palazzo Bahia',
        name_es: 'Palacio Bahia',
        description_en: 'A stunning 19th-century palace showcasing the best of Moroccan architecture and craftsmanship.',
        description_ar: 'قصر مذهل من القرن التاسع عشر يعرض أفضل العمارة والحرفية المغربية.',
        description_fr: 'Un palais magnifique du 19ème siècle présentant le meilleur de l\'architecture et de l\'artisanat marocains.',
        description_it: 'Un palazzo mozzafiato del XIX secolo che mostra il meglio dell\'architettura e dell\'artigianato marocchino.',
        description_es: 'Un palacio impresionante del siglo XIX que muestra lo mejor de la arquitectura y artesanía marroquí.',
        category_en: 'historical',
        category_ar: 'تاريخي',
        category_fr: 'historique',
        category_it: 'storico',
  ...
  const festivals = await Promise.all([
    prisma.festival.create({
      data: {
        ...
        timeOfYear: 'November',
        duration: 10,
        images: ['https://images.unsplash.com/photo-1553603228-0f7053e3279e?w=800'],
        established: '2001',
  ...
  const cuisines = await Promise.all([
    prisma.cuisine.create({
      data: {
        ...
        type: 'main-dish',
        regionIds: [regions[0].id, regions[1].id, regions[2].id],
        ingredients: ['lamb', 'chicken', 'vegetables', 'spices', 'olive-oil'],
        spiceLevel: 'medium',
        images: ['https://images.unsplash.com/photo-1553603228-0f7053e3279e?w=800'],
        popularVariants: ['Lamb Tagine', 'Chicken Tagine', 'Vegetable Tagine'],
      },
    }),
    prisma.cuisine.create({
      data: {
        ...
        type: 'main-dish',
        regionIds: [regions[0].id, regions[1].id, regions[2].id],
        ingredients: ['semolina', 'lamb', 'vegetables', 'chickpeas', 'raisins'],
        spiceLevel: 'mild',
        images: ['https://images.unsplash.com/photo-1553603228-0f7053e3279e?w=800'],
        popularVariants: ['Seven Vegetable Couscous', 'Lamb Couscous', 'Fish Couscous'],
      },
    }),
  ]);
  ...
  const heritages = await Promise.all([
    prisma.heritage.create({
      data: {
        ...
        type: 'music-dance',
        regionIds: [regions[0].id, regions[1].id],
        images: ['https://images.unsplash.com/photo-1553603228-0f7053e3279e?w=800'],
  ...
  const clothing = await Promise.all([
    prisma.clothing.create({
      data: {
        ...
        occasions: ['daily-wear', 'religious-ceremonies', 'formal-events'],
        images: ['https://images.unsplash.com/photo-1553603228-0f7053e3279e?w=800'],
    ...
    prisma.clothing.create({
      data: {
        ...
        gender: 'female',
        regionIds: [regions[0].id, regions[1].id, regions[2].id],
        materials: ['silk', 'brocade', 'embroidery'],
        occasions: ['weddings', 'religious-celebrations', 'formal-events'],
        images: ['https://images.unsplash.com/photo-1553603228-0f7053e3279e?w=800'],
