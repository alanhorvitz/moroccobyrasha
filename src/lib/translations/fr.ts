export const fr = {
  ...
  tourism: {
    ...
    searchTourPackages: 'Rechercher des forfaits touristiques...',
    searchTravelGuides: 'Rechercher des guides de voyage...',
    searchVirtualTours: 'Rechercher des visites virtuelles...',
    durationRange: 'Durée (jours) : {from} - {to}',
    priceRange: 'Fourchette de prix : {from} - {to}',
    noTourPackages: "Aucun forfait touristique trouvé correspondant à vos critères.",
    noTravelGuides: "Aucun guide de voyage trouvé correspondant à vos critères.",
    noVirtualTours: "Aucune visite virtuelle trouvée correspondant à vos critères.",
    ...
    experience360: 'Expérience 360°',
    startVirtualTour: 'Commencer la visite virtuelle',
  },
